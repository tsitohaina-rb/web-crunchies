...
import LoadMorePosts from "@/components/main/blog/LoadMorePosts";
...
const BlogPage = async () => {
  ...
  const initialPosts = blogPosts.slice(0, initialDisplayCount);
      ...
      <div className="container-custom py-16">
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-3/4">
            <LoadMorePosts initialPosts={initialPosts} allPosts={blogPosts} />
          </div>
